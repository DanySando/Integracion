...
parser.add_argument('--imgsz', type=int, default=640)  # antes 1280
parser.add_argument('--conf', type=float, default=0.5)
parser.add_argument('--track', action='store_true')
# acelerar: procesar solo 1 de cada N frames
parser.add_argument(
    '--frame-step',
    type=int,
    default=1,
    help='Procesar solo 1 de cada N frames para acelerar'
)
# histórico
parser.add_argument(
    '--log-dir',
...
class CountObject:
    def __init__(self, input_video_path, output_video_path) -> None:
        ...
        self.model = YOLO('yolov8n.pt')  # modelo nano (rápido)
        ...
        print(f"[INFO] Frame-step: {args.frame_step}")
    ...
    def process_video(self):
        ...
        while True:
            ...
            # si no toca, se escribe el frame sin detección

            out.write(frame)

            i += 1
            if i % (30 * max(1, args.frame_step)) == 0:
                print(
                    f"[INFO] Leídos {i} frames (procesando 1 de cada {args.frame_step})"
                )
...
# python conteo2.py -i "demo2.mp4" -o "demo2_out.mp4" --imgsz 480 --frame-step 5

# para generar un proceso del video mas rapido.


# para utilizarlo con camaras IP.
# python conteo.py ^ -i "rtsp://usuario:password@192.168.1.50:554/Streaming/Channels/101" ^ -o "cam_out.mp4" ^ --imgsz 480 ^ --frame-step 5
